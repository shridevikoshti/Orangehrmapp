...
// clicking on login
	...
	//clicking on my info
		...
		//clicking on emergency contact details
		...
		driver.findElement(By.xpath(s.getCell(1, 19).getContents())).sendKeys(s.getCell(1, 20).getContents());
		driver.findElement(By.xpath(s.getCell(1, 21).getContents())).click();
		//deleting added contact
		...
		//adding another emergency contact without name
		...
		//adding another emergency contact without relationship
		
			driver.findElement(By.xpath(s.getCell(1, 11).getContents())).sendKeys(s.getCell(1, 12).getContents());
			driver.findElement(By.xpath(s.getCell(1, 13).getContents())).clear();
			driver.findElement(By.xpath(s.getCell(1, 15).getContents())).sendKeys(s.getCell(1, 16).getContents());
			driver.findElement(By.xpath(s.getCell(1, 17).getContents())).sendKeys(s.getCell(1, 18).getContents());
			driver.findElement(By.xpath(s.getCell(1, 19).getContents())).sendKeys(s.getCell(1, 20).getContents());
			driver.findElement(By.xpath(s.getCell(1, 21).getContents())).click();
